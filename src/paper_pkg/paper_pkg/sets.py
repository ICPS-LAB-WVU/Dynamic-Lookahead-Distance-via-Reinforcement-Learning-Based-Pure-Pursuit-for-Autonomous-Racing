...
class PurePursuit(Node):
    def __init__(self):
        ...
        self.is_real = False
        self.map_name = 'BrandsHatch_fast'
    ...
    def build_control_gain(self, speed, v_min=5.6, v_max=16.5, gain_min=0.65, gain_max=0.7):
    ...
    def pose_callback(self, pose_msg):
        ...
        L_dynamic = self.L + 1.0 if speed >= 6.3 else self.L
        ...
        print(f"Pos=({self.currX:.2f}, {self.currY:.2f}), Steer={gamma:.3f}, Speed={self.drive_msg.drive.speed:.2f}")
