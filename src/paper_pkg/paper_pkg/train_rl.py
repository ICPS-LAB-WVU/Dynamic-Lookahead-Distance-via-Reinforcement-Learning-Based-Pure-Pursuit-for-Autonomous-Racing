...
def main():
    ...
    train_env = DummyVecEnv([lambda: Monitor(F1TenthEnv())])
    train_env = VecNormalize(train_env, norm_obs=True, norm_reward=True)

    eval_env = DummyVecEnv([lambda: Monitor(F1TenthEnv())])
    ...
    initial_lr = 0.00023927041608653033
    ...
    model = PPO(
        ...
        train_env,
        verbose=1,
        learning_rate=lambda f: initial_lr * f,
        n_steps=4096,
        batch_size=256,
        n_epochs=5,
        gamma=0.99,
